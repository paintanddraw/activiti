...
public class OnboardingRequest {
	public static void main(String[] args) throws ParseException {
		...
		ProcessEngineConfiguration config = new StandaloneProcessEngineConfiguration()
				.setJdbcUrl("jdbc:mysql://localhost:3306/activiti-api?characterEncoding=utf8&useSSL=true")
		...
		Deployment deployment = repositoryService.createDeployment().addClasspathResource("/processes/leaveProcess.bpmn")
				.deploy();
